...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        if (self.optionSegmentedControl.selectedSegmentIndex)
        {
            ...
            cell.eventType.text = [NSString stringWithFormat:@"Event Entry Type: %@", [[aEvent objectForKey:@"eventType"] intValue] ? @"Paid" : @"Free"];
        }
        cell.eventName.text = [NSString stringWithFormat:@"Event Name: %@", [aEvent objectForKey:@"eventName"]];
